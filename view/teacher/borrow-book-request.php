                    ...
                    <div id="table-datatables">
                        ...
                        <div class="col s12 m8 l8 ">
                            ...
                            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                ...
                                $all_req = $bok->all_book_req_by_user(0,$_SESSION['tcr_id']);
                    ...
                    <div id="table-datatables">
                        ...
                        <div class="col s12 m8 l8 ">
                            ...
                            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                ...
                                $all_req = $bok->all_book_req_by_user(1,$_SESSION['tcr_id']);
                    ...
                    <div id="table-datatables">
                        ...
                        <div class="col s12 m8 l8 ">
                            ...
                            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
                                ...
                                $all_req = $bok->all_book_req_by_user(2,$_SESSION['tcr_id']);
