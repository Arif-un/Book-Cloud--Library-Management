...
$obj = new nofications();
$new = $obj->notifyCountById(1, $_SESSION['tcr_id']);
    ...
    <div class="navbar-fixed">
        <nav class="navbar-color">
            <div class="nav-wrapper">
                <ul class="left">
                    <li><h1 class="logo-wrapper"><a href="../teacher/index.php" class="brand-logo darken-1"><img
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li>
                        ...
                        <div class="waves-effect" style="width:45px;height: 45px;border-radius: 50%;"><a
                                    href=""></a><img
                                    src="http://localhost/Book-Cloud\/resource/photos/teacher/<?php echo $_SESSION['photo'] ?>"
                ...
                <ul id="notifications-dropdown" class="dropdown-content"
                    ...
                    <li class="divider"></li>
                    <?php
                    $all = $obj->allNotificationsById(1, $_SESSION['tcr_id']);
                    ...
                    foreach ($all as $item) { ?>
                        ...
                        <li id="<?php echo $item->id ?>" onclick="seenNotify(this)" class="waves-effect"
                            ...
                            <a style="height: 100%;width: 100%;word-wrap:break-word;"
                               href="../../view/teacher/<?php if ($item->title == "Request Decline") {
